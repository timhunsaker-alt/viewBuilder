...
import { ViewDefinitions } from "./pages/ViewDefinitions";
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/view-definitions" element={<ViewDefinitions />} />
        ...
        <Route
          path="/view-definitions/:viewDefinitionId/preview"
          element={<ViewPreviewResults />}
        />
        <Route
